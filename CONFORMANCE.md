...
| Subscription duration: default 1 hour, minimum 1 minute, maximum 24 hours | §2.4.1, §2.4.2 | `notify.sip_notifier` | `test_sip_notifier::test_default_duration_when_expires_absent`, `test_expires_below_minimum_returns_423`, `test_expires_above_maximum_is_clamped` |
| Expires < 1 minute MUST be rejected (423 Interval Too Brief, with Min-Expires) | §2.4.1, §2.4.2 | `notify.sip_notifier` | `test_sip_notifier::test_expires_below_minimum_returns_423`, `test_expires_exactly_minimum_accepted` |
